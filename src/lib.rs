...
#[derive(Debug)]
pub struct ToriiGateProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ToriiGateProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ToriiGate processing");
    
    let mut processor = ToriiGateProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ToriiGateProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ToriiGateProcessor::new(false);
